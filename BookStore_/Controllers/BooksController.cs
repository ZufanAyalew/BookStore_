...
namespace BookStore_.Controllers
{
    ...
    {
        private readonly BookStore_Context _context;

        public BooksController(BookStore_Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Books != null ? 
                          ...
                          Problem("Entity set 'BookStore_Context.Books'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'BookStore_Context.Books'  is null.");
            }
            var book = await _context.Books.FindAsync(id);
            if (book != null)
            {
